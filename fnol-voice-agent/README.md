...
- **Go to the largest carriers directly and try to skip the call.** A handful of carriers
  ...
  integration that submits the claim straight into their system, which would be faster and
  cheaper than dialing them and would leave the voice agent to cover the long tail. We have
  built that kind of direct integration successfully on other work. It was out of scope here.
